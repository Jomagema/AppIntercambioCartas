...
import com.example.appintercambiocartas.User
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loginPassword = findViewById(R.id.registerpasswordEditText)
        loginButton = findViewById(R.id.loginButton)
        loginGoRegisterButton = findViewById(R.id.registrarseButton)
